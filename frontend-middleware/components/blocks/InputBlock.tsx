...
function InputBlockNode({ id, data, isConnectable = true }: InputBlockNodeProps) {
  ...
  return (
    <div className="p-4 border-2 border-gray-300 rounded-lg bg-[#0e6e2e] shadow-lg min-w-[300px]">
      ...
      <div className="flex items-center mb-4">
        ...
        <div className="flex-grow flex items-center">
          <div className="text-sm font-mono text-white">Input(</div>
