...
interface OutputBlockNodeProps {
  id: string
  data: {
    label: string
    sizeIn: number
...
function OutputBlockNode({ id, data, isConnectable = true }: OutputBlockNodeProps) {
  ...
  return (
    <div className="p-4 border-2 border-gray-300 rounded-lg bg-[#721ab0] shadow-lg min-w-[300px]">
      ...
      <div className="flex items-center mb-4">
        ...
        <div className="flex-grow flex items-center">
          <div className="text-sm font-mono text-white">Output(</div>
      ...
      <div className="bg-[#1a2535] bg-opacity-60 rounded p-2 mb-4">
        <div className="flex items-center mb-2">
          <div className="text-xs text-gray-400 mr-2 w-24">Input Size:</div>
          <input
            type="number"
            value={data.sizeIn}
        ...
        <div className="flex items-center mb-2">
          <div className="text-xs text-gray-400 mr-2 w-24">Output Size:</div>
          <input
            type="number"
            value={data.sizeOut}
...
export default OutputBlockNode